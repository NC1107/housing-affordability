 ...
 * For expanding state codes (e.g., "NC") to full names (e.g., "North Carolina")
 */
 ...
 * @param abbr - State abbreviation (e.g., "NC")
 * @returns Full state name (e.g., "North Carolina") or original input if not found
 */
